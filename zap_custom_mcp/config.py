...
SESSION_STRATEGY = os.environ.get(
...
LONG_SCAN_TIMEOUT = int(
    os.environ.get("ZAP_LONG_SCAN_TIMEOUT", "14400")
)  # 4 hours default

# MCP Server timeout configuration
MCP_SERVER_TIMEOUT = int(
    os.environ.get("ZAP_MCP_SERVER_TIMEOUT", "300")
)  # 5 minutes default
MCP_HEARTBEAT_INTERVAL = int(
    os.environ.get("ZAP_MCP_HEARTBEAT_INTERVAL", "30")
)  # 30 seconds default

# Scan-specific timeout overrides
DEFAULT_ACTIVE_SCAN_TIMEOUT = int(
    os.environ.get("ZAP_DEFAULT_ACTIVE_SCAN_TIMEOUT", "7200")
)  # 2 hours
DEFAULT_SPIDER_TIMEOUT = int(
    os.environ.get("ZAP_DEFAULT_SPIDER_TIMEOUT", "1800")
)  # 30 minutes
DEFAULT_AJAX_TIMEOUT = int(
    os.environ.get("ZAP_DEFAULT_AJAX_TIMEOUT", "300")
)  # 5 minutes
DEFAULT_PASSIVE_TIMEOUT = int(
    os.environ.get("ZAP_DEFAULT_PASSIVE_TIMEOUT", "600")
)  # 10 minutes

# HTTP timeout configuration
HTTP_CONNECT_TIMEOUT = int(
    os.environ.get("ZAP_HTTP_CONNECT_TIMEOUT", "30")
)  # 30 seconds
HTTP_READ_TIMEOUT = int(os.environ.get("ZAP_HTTP_READ_TIMEOUT", "600"))  # 10 minutes
HTTP_POOL_SIZE = int(
    os.environ.get("ZAP_HTTP_POOL_SIZE", "50")
)  # Connection pool size  # 4 hours for long scans
